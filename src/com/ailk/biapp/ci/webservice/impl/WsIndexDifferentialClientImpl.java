...
@Service
@WebServiceClient
public class WsIndexDifferentialClientImpl implements IIndexDifferentialClient {
    private Logger log = Logger.getLogger(this.getClass());
    @Autowired
    private ICiSysInfoHDao ciSysInfoHDao;

    public WsIndexDifferentialClientImpl() {
    }

    public String sendDataToSA(String xmlBody) {
        this.log.info("Enter WsIndexDifferentialClientImpl.sendDataToSA()");
        String sysId = Configure.getInstance().getProperty("FROM_SA_SYS_ID");
    ...
    public static void main(String[] args) {
        ...
        WsIndexDifferentialClientImpl client = new WsIndexDifferentialClientImpl();
