...
public class EChartBarImpl implements IChart {
    public EChartBarImpl() {
    }
    ...
    public String createChart(ChartModel chartModel, List<Map<String, Object>> data) {
        ...
        while(var18.hasNext()) {
            ...
            ((Label)bar.itemStyle().normal().label().show(Boolean.valueOf(true))).position(Position.right);
