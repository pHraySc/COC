...
<div id="systemTip"  class="hidden"  >
    ...
    <div class="systemTipNextStepBox">
         <div class="fleft systemTipNextStepLeft">
			  ...
			  <p>
			   	 保存成功，你可以通过<a href="javascript:toTemplateList();" class="active">用户群模板</a>
			    	 查看本次操作，并进行相应的模板管理.
			  </p>
		   </div>
		   <div class="fright systemTipNextStepRight">
			  ...
			  <p>保存成功，你可以通过<a href="javascript:toCustomList();" class="active">用户群集市</a>
			     	查看本次操作，并进行相应的用户群管理.
			  </p>
		   </div>
    </div>
    ...
    <div class="successTipBox">
        ...
        <div class="fright successTipRightBox">
                 <h4  id="customerName_only"></h4>
				  <p>
					保存成功，你可以通过<a href="javascript:toCustomList();" class="active">用户群集市</a>
					 查看本次操作，并进行相应的用户群管理.
				  </p>
 ...
 <div id="successTip">
		...
		<div class="successTipBox"  id="customer"  style="display:none;">
			   ...
			   <div class="fright  successTipRightBox">
				  <h4  id="customerName"></h4>
				  <p>
					保存成功，你可以通过<a href="javascript:toCustomList();">用户群管理</a>
					 查看本次操作，并进行相应的用户群管理.
				  </p>
			   </div>
		</div>
		<div class="systemTipNextStepBox" id="customerAndTemplate" style="display:none;">
		   <div class="fleft systemTipNextStepLeft">
		      <div class="tipNextStepImg"> </div>
			  <h4 id="customerName"> </h4>
			  <p>保存成功，你可以通过<a href="javascript:toCustomList();">用户群管理</a>
			     	查看本次操作，并进行相应的用户群管理.
			  </p>
		   </div>
		   <div class="fright systemTipNextStepRight">
