		...
		<li class="market-customer-item"> 
			<div class="clearfix market-customer-details J_customer_datils">
			 	<div class="fleft market-customer-info customer-name">
					...
					<ol class="hotState fleft newVersion">
					...
					<%-- <c:if  test="${label.isAttention == 'true'}">
						<span class="collectStar fleft newVersion" labelorcustomid="${label.labelId }" isattention="true">
							<img class="J_label_market_list_cancel_attention" title="点击可取消收藏此标签" id="attentionImg_${label.labelId }" labelid="${label.labelId }" style="cursor: pointer;" src="${ctx}/aibi_ci/assets/themes/default/images/favorite.png">
						</span>
					</c:if> --%>
				</div> 
				<div class="fright market-customer-info">
					<div class="fright market-info-list-box ">
						...
						<div></div>
						<a class="market-info-list-btn J_label_attention_operation_btn"  labelId="${label.labelId }"></a>
						<span class="resultItemActiveList hidden" id="operate_${label.labelId }">
							<ol class="clearfix">
		           	  			<li><a class="J_label_market_list_cancel_attention" href="javascript:void(0);" labelId="${label.labelId}">取消收藏</a></li>
