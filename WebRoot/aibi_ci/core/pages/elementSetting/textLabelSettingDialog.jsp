...
<head>
	...
	$(function(){
		var darkValue =  decodeURIComponent('${param["ciLabelRule.darkValue"]}');
		var queryWay = '${param["ciLabelRule.queryWay"]}';
		var exactValue = decodeURIComponent('${param["ciLabelRule.exactValue"]}');
		//导入按钮事件
	...
	function setDarkValue(){
		if(validateForm()){
			...
			target.attr("darkValue",darkValue);
			...
			parent.ShoppingCart.iframeCloseDialog("#textLabelSetting");
		}
	}
