...
function loadRecommendLabelList(){
    ...
    $("#noResults").hide();
	//需要获取总页数
	var getTotalUrl = $.ctx + "/ci/ciLabelInfoAction!findSysRecommendLabelNum.ai2do";
	$.post(getTotalUrl,{},function(result) {
		if (result.success) {
			...
			var i = totalPage;
			if(i != 0){
				var actionUrl = $.ctx + "/ci/ciLabelInfoAction!findSysRecommendLabel.ai2do?pager.totalPage=" + totalPage;
...
<div class="comWidth pathNavBox">
     <span class="pathNavHome"> 系统热门标签</span>
