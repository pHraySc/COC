...
<body>
<form id="saveForm" method="post" action="<%=request.getContextPath()%>/ci/ciLabelInfoConfigAction!loadLabelClassFile.ai2do" enctype="multipart/form-data">
		...
		<ol class="clearfix">
			...
			<li> 
			    ...
			    <div class="fleft" >
			       ...
			       <a id="importTip" class="fleft downAndHelp" href="<%=request.getContextPath() %>/ci/ciLabelInfoConfigAction!downLabelClassFile.ai2do" title="">示例</a>
