...
<body>
<form id="saveForm" method="post" action="<%=request.getContextPath() %>/ci/ciLabelInfoConfigAction!loadLabelInfoFile.ai2do" enctype="multipart/form-data">
		...
		<ol class="clearfix">
			...
			<li> 
			    ...
			    <div class="fleft" >
			       ...
			       <a id="importTip" class="fleft downAndHelp " href="<%=request.getContextPath() %>/ci/ciLabelInfoConfigAction!downImportTempletFile.ai2do?pojo.isVertLabel=0" title="">示例</a>
