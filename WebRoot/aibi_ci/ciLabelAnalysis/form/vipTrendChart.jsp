...
<chart caption="${caption}" palette="1" baseFontSize="12" 
		yAxisName='' shownames="1" showvalues="0" useRoundEdges="1" legendBorderAlpha="0" bgColor="ffffff" yAxisNameWidth="16" 
	...
	<c:forEach items="${labelFormList}" var="vipForm">
		<set label="${dateFmt:dateFormat(vipForm.dataDate)}" value="${vipForm.customNum}" />
	</c:forEach>
	<set/>
<styles>
      <definition>
