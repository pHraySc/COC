...
<chart caption=""  formatNumberScale='0' palette='2' xAxisMinValue='0' xAxisMaxValue='100' yAxisMinValue='0' yAxisMaxValue='100' is3D='0' viewMode='0'
 ...
 bgColor="ffffff" showBorder="0" baseFontSize="12" baseFont="Microsoft YaHei" outCnvBaseFont="Microsoft YaHei">
   ...
   <dataset showPlotBorder="0">
      <set x='50' y='50' radius='55' toolText="" shape='circle' name='${fn:replace(fn:replace(ciLabelRelModel.mainLabelName,">","&gt;"),"<","&lt;")} <fmt:formatNumber type="number" value="${ciLabelRelModel.mainLabelUserNum}" pattern="###,###,###" />' color='6CA9DC' id='${ciLabelRelModel.mainLabelId}' link=''/>
   </dataset>
   ...
   <c:if test="${!empty ciLabelRelModelList}">
	   <connectors color='D7E9F8'>
	   		<c:forEach items="${ciLabelRelModelList}" var="relLabel">
