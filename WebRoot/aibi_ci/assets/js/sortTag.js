...
function saveButtonsDisplay() {
	...
	if(!flag) {
		...
		$('#tagCalcSaveBtn').removeClass('market-cart-button').addClass('market-cart-button-disable');
		
		//$('#tagCalcExplore').unbind('click');
		$('#tagCalcSaveTemplateBtn').unbind('click');
		$("#customerNum").empty();
		$("#showShopCartRuleCalculate").hide();
		$("#tagCalcExplore").hide();
	} else {
		//if($('.tagSaveActionBox').find('input').hasClass('tag_btn_dis')) {
			...
			$('#tagCalcSaveBtn').removeClass('market-cart-button-disable').addClass('market-cart-button');
			
			//$('#tagCalcExplore').bind('click', explore);
			$('#tagCalcSaveTemplateBtn').bind('click', saveTemplate);
			$("#showShopCartRuleCalculate").show();
			$("#tagCalcExplore").show();
		//}
	}
}
