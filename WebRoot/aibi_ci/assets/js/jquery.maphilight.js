	...
	if(has_canvas) {
		fader = function(element, opacity, interval) {
			if(opacity <= 1) {
				...
				window.setTimeout(fader, 30, element, opacity + 0.1, 10);
			}
		};
		...
		//IE8对VML的支持有变化,故作此更改
		document.createStyleSheet().addRule("v\\:shape", "behavior: url(#default#VML); antialias: true;");
		document.createStyleSheet().addRule("v\\:fill", "behavior: url(#default#VML); antialias: true;");
		document.createStyleSheet().addRule("v\\:stroke", "behavior: url(#default#VML); antialias: true;");
		//document.createStyleSheet().addRule("v\\:rect", "behavior: url(#default#VML); antialias: true;");
		//document.createStyleSheet().addRule("v\\:oval", "behavior: url(#default#VML); antialias: true;");
