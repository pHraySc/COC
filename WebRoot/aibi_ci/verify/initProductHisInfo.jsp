...
<script type="text/javascript">
	...
	function loadProductTrendChart(){
		...
		var url=escape($.ctx+'/ci/ciProductVerifyInfoAction!productHisInfo.ai2do?ciVerifyRuleRel.offerId='+offerId);
		var noData = '产品暂无统计数据';
                var chartParam = "?ChartNoDataText="+noData+"&InvalidXMLText="+noData+"&LoadDataErrorText="+noData;
		$("#chart").show();
		var bar = new FusionCharts($.ctx+"/aibi_ci/assets/flash/MSLine.swf"+chartParam, "",$('#chart').width(), $('#chart').height(), "0", "0");
