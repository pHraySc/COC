				...
				if(_isSuccess == 'false'){
					...
					easyloader.load('datagrid', function(){ //加载指定模块 
						$("#groupGridList").datagrid({
						    ...
						    loadMsg:'正在加载数据，请稍候',
						    url:'${ctx}/ci/customersManagerAction!findGroupInfoList.ai2do?ciCustomGroupInfo.customGroupId=${ciCustomGroupInfo.customGroupId}&'
						    		+'ciCustomGroupInfo.dataDate=${ciCustomGroupInfo.dataDate}',
						    columns:[[
					  			<%
